				...
				<li>
					<div class="prog-row">
						<div class="user-thumb">
							<a href="#"><img src="/static/images/avatar1_small.jpg"
								alt=""></a>
						</div>
					...
					<div class="prog-row">
						<div class="user-thumb">
							<a href="#"><img src="/static/images/avatar1.jpg" alt=""></a>
						</div>
						<div class="user-details">
							<h4>
					...
					<div class="prog-row">
						<div class="user-thumb">
							<a href="#"><img src="/static/images/chat-avatar2.jpg" alt=""></a>
						</div>
						<div class="user-details">
							<h4>
								<a href="#">Jhone Doe</a>
				...
				<li>
					<div class="prog-row">
						...
						<div class="rsn-details ">
							...
							<p>
								<a href="#">John Sinna </a>Purchased new equipments for zonal
								office setup
							</p>
						</div>
					</div>
					<div class="prog-row">
						...
						<div class="rsn-details ">
							...
							<p>
								<a href="#">Sumon </a>Purchased new equipments for zonal office
								setup
							</p>
						</div>
					</div>
					<div class="prog-row">
						...
						<div class="rsn-details ">
							...
							<p>
								<a href="#">Mosaddek </a>Purchased new equipments for zonal
								office setup
							</p>
						</div>
					</div>
